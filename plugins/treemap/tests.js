...
describe('Testing Treemap', function() {
    ...
    var checkEmptyData = function(done) {
        ...
        request
            .get('/o?api_key=' + API_KEY_ADMIN + "&app_key=" + API_KEY_ADMIN + "&app_id=" + APP_ID + "&method=treemap&treemap_type=[CLY]_session")
            .expect(200)
    ...
    it('Should validate session data', function(done) {
        ...
        request
            .get('/o?api_key=' + API_KEY_ADMIN + '&app_id=' + APP_ID + '&method=treemap&treemap_type=[CLY]_session')
            .expect(200)
            .end(function(err, res) {
    ...
    it('Should validate login data', function(done) {
        ...
        APP_KEY = testUtils.get("APP_KEY");
        request
            .get('/o?api_key=' + API_KEY_ADMIN + "&app_key=" + API_KEY_ADMIN + "&app_id=" + APP_ID + "&method=treemap&treemap_type=Login")
            .expect(200)
            .end(function(err, res) {
