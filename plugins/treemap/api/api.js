...
(function() {
    plugins.register("/i", function(ob) {
        ...
        var collectionName = "treemap" + appId;
    ...
    plugins.register("/o", function(ob) {
        ...
        if (params.qstring.method === "treemap") {
            ...
            var treemapType = params.qstring.treemap_type;
    ...
    /**
     * Fetch Treemap Visualization Plugin
     * @param {string} collectionName | Name of collection
     * @param {object} criteria | Filter object
     * @param {func} callback | Callback function
     */
    function fetchTreemapData(collectionName, criteria, callback) {
    ...
    plugins.register("/i/apps/clear_all", function(ob) {
        common.db.collection("treemap" + ob.appId).drop(function() { });
    });
