...
(function(treemapPlugin, $) {
    ...
    treemapPlugin.loadTimesOfDay = function(timesOfDayData, event) {
        ...
        function loadPunchCard(punchCardData) {
            ...
            var labelMapping = {
                "0": jQuery.i18n.map['treemap.sunday'],
                "1": jQuery.i18n.map['treemap.monday'],
                "2": jQuery.i18n.map['treemap.tuesday'],
                "3": jQuery.i18n.map['treemap.wednesday'],
                "4": jQuery.i18n.map['treemap.thursday'],
                "5": jQuery.i18n.map['treemap.friday'],
                "6": jQuery.i18n.map['treemap.saturday']
            };
        ...
        function update(data, labelsX) {
            ...
            dotLabelEnter.on('mouseover', function(d, i) {
                ...
                var svgPosition = d3.select('#treemap-chart-area').node().getBoundingClientRect();
                ...
                var contentText = jQuery.i18n.prop('treemap.tooltip-1', countlyCommon.formatNumber(d.value), event, d.label, startHourText, endHourText) + "<br/>";
                contentText += d.value > 0 ? jQuery.i18n.prop('treemap.tooltip-' + (percentage > 0 ? "more" : "less") + '-than', Math.abs(percentage.toFixed(0))) : "";
